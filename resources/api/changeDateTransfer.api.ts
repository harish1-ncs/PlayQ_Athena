export const api = {
    changeDateTransferCase: {
        method: 'POST',
        path: '/cases/api/UpdateTransferCase',
        params: {},
        headers: {
            Accept: "*/*",
    ...
    createNewMembership: {
        ...
        body: {
            "FullName": "#{var.NRIC.Name}",
            "UIN": "#{var.NRIC}",
            "DateofBirth": "#{var.NRIC.Year}",
            "EmploymentType": "4",
            "Occupation": "IT",
            ...
            "AccountHolderName": "#{var.NRIC.Name}",
